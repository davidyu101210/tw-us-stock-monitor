...
st.set_page_config(page_title="台美股看盤 iPhone v1.3", layout="wide")
...
st.title("台股＋美股自動看盤 v1.3 iPhone PWA 版")
...
st.divider()
st.caption("v1.3：iPhone PWA；13F 每日檢查＋最後成功資料快取，來源暫時失敗也不中斷顯示。")
